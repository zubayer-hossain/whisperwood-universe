# {{character.displayName}} — Image Generation Prompt
...
Copy the block below into any image generation tool.
...
| Emotional expression | Character Design Guide → Expressions |
| Canonical constraints | CANON.md |
| Art direction | imageProfile, Character Design Guide |
| Lighting | imageProfile, World Art Direction → Lighting |
